            ...
            children: [
              {
                ...
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/imprimir-directorio',
              },
              {
                id: 'imprimir-ficha',
                title: 'Impresión de formato ficha de campo',
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/imprimir-ficha-campo',
              },
              {
                id: 'total-gosc',
                title: 'Total de GOSC en el estado, por municipio e integración de JER',
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/total-gosc-estado',
              },
              {
                id: 'tipos-gosc',
                title: 'Tipos de GOSC en el estado, por municipio e integración de JER',
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/tipos-gosc-estado',
              },
              {
                id: 'sexo-gosc',
                title: 'Por sexo de los representantes de los GOSC',
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/sexo-de-representantes-gosc',
              },
              {
                id: 'total-propuestas',
                title: 'Total de los GOSC con las propuestas realizadas en el estado, por municipio e integración de JER',
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/total-propuestas-gosc',
              },
              {
                id: 'datos-gosc',
                title: 'Datos de nombre del GOSC y su correo electrónico',
                type: 'item',
                url: '/grupos-organizados-de-la-sociedad-civil/reportes/nombre-correo-gosc',
              },
